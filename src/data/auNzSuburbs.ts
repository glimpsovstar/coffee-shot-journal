...
export const AU_NZ_SUBURBS: SuburbEntry[] = [
  ...
  { id: 'au-nsw-epping', name: 'Epping', state: 'NSW', country: 'AU', latitude: -33.7726, longitude: 151.0818 },
  { id: 'au-nsw-strathfield', name: 'Strathfield', state: 'NSW', country: 'AU', latitude: -33.8715, longitude: 151.0935 },
  ...
  { id: 'au-nsw-st-leonards', name: 'St Leonards', state: 'NSW', country: 'AU', latitude: -33.8244, longitude: 151.1982 },
  { id: 'au-nsw-ultimo', name: 'Ultimo', state: 'NSW', country: 'AU', latitude: -33.8795, longitude: 151.1985 },
  { id: 'au-nsw-baulkham-hills', name: 'Baulkham Hills', state: 'NSW', country: 'AU', latitude: -33.7375, longitude: 150.9785 },
  // VIC
  ...
  { id: 'au-vic-wantirna', name: 'Wantirna', state: 'VIC', country: 'AU', latitude: -37.8681, longitude: 145.2411 },
  { id: 'au-vic-ringwood', name: 'Ringwood', state: 'VIC', country: 'AU', latitude: -37.8134, longitude: 145.2296 },
  { id: 'au-vic-box-hill', name: 'Box Hill', state: 'VIC', country: 'AU', latitude: -37.8197, longitude: 145.1236 },
  { id: 'au-vic-camberwell', name: 'Camberwell', state: 'VIC', country: 'AU', latitude: -37.8268, longitude: 145.0622 },
  { id: 'au-vic-hawthorn', name: 'Hawthorn', state: 'VIC', country: 'AU', latitude: -37.822, longitude: 145.0289 },
  { id: 'au-vic-southbank', name: 'Southbank', state: 'VIC', country: 'AU', latitude: -37.8235, longitude: 144.9638 },
  { id: 'au-vic-sunshine', name: 'Sunshine', state: 'VIC', country: 'AU', latitude: -37.7875, longitude: 144.832 },
  { id: 'au-vic-cheltenham', name: 'Cheltenham', state: 'VIC', country: 'AU', latitude: -37.965, longitude: 145.0465 },
  { id: 'au-vic-mount-helen', name: 'Mount Helen', state: 'VIC', country: 'AU', latitude: -37.6835, longitude: 143.8835 },
  // QLD
  ...
  { id: 'au-qld-milton', name: 'Milton', state: 'QLD', country: 'AU', latitude: -27.4688, longitude: 153.0075 },
  { id: 'au-qld-bundall', name: 'Bundall', state: 'QLD', country: 'AU', latitude: -28.0015, longitude: 153.4105 },
  // WA
  ...
  { id: 'au-wa-west-perth', name: 'West Perth', state: 'WA', country: 'AU', latitude: -31.9482, longitude: 115.839 },
  // SA
  ...
  { id: 'au-act-forrest', name: 'Forrest', state: 'ACT', country: 'AU', latitude: -35.3078, longitude: 149.1335 },
  // TAS
  ...
  { id: 'nz-wynyard-quarter', name: 'Wynyard Quarter', state: 'Auckland', country: 'NZ', latitude: -36.8442, longitude: 174.7582 },
  { id: 'nz-east-tamaki', name: 'East Tamaki', state: 'Auckland', country: 'NZ', latitude: -36.9345, longitude: 174.8745 },
  // NZ — Wellington
