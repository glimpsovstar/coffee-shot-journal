...
export function backupIncludesCafes(backup: JournalBackupFile): backup is JournalBackupFile & { cafes: Cafe[] } {
  return Array.isArray(backup.cafes);
}
